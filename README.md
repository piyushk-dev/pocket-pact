...
The landing page at `/` includes a four-step animated phone walkthrough, feature previews and FAQs. Click **Demo** to open the interactive app at `/app`. The animation supports pause, step selection and reduced-motion preferences.
